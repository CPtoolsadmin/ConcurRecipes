...
2. Click the **Travel** tab.
     ...
     ```
        <html>
        <body>
        <img src="/images/Concur_admin_console_num" alt="Add New Reservation" width="647" height="217">
        </body>
        </html>
      ```

3. In Travel Alerts, click the **Upcoming Trips** tab.
4.  Click **Add new Itinerary manually**.
5. The Add New Reservation dialog appears. **Select Create New Trip** from the drop down, **Add Reservation to Trip**.

    ```
      <html>
      <body>
      <img src="/images/Create_new_trip_num" alt="Create new trip" width="373" height="453">
      </body>
      </html>
     ```
...
6. Select from: Add Flight, Add Car, Add Hotel or Add Rail (not shown). Enter the appropriate test data by using the drop down features or by using the free form fields.
    ...
    <html>
    <body>
    <img src="/images/Add_New_Reservation_num" alt="Add New Reservation" width="900" height="302">
    </body>
    </html>
    ```
...
8. Click **Trip Library** to see your manually created itinerary.
  ...
  <html>
  <body>
  <img src="/images/Concur_admin_consol_trip_library_num" alt="Click trip Library" width="648" height="183">
  </body>
  </html>
  ```
